...
public class VkApi : IVkApi
{
    ...
    {
        return _auth.AuthorizeAsync(@params);
    }

    public Task RefreshTokenAsync(Func<string>? code = null)
    {
        return _auth.RefreshTokenAsync(code);
    }

    public Task LogOutAsync()
    {
        return _auth.LogOutAsync();
    }
    ...
    public INotesCategory Notes
    {
        get => _categories.Notes;
        set => throw new NotSupportedException();
    }

    public IAppWidgetsCategory AppWidgets
    {
        get => _categories.AppWidgets;
        set => throw new NotSupportedException();
    }

    public IOrdersCategory Orders
    {
        get => _categories.Orders;
        set => throw new NotSupportedException();
    }

    public ISecureCategory Secure
    {
        get => _categories.Secure;
        set => throw new NotSupportedException();
    }

    public IStoriesCategory Stories
    {
        get => _categories.Stories;
        set => throw new NotSupportedException();
    }

    public ILeadFormsCategory LeadForms
    {
        get => _categories.LeadForms;
        set => throw new NotSupportedException();
    }

    public IPrettyCardsCategory PrettyCards
    {
        get => _categories.PrettyCards;
        set => throw new NotSupportedException();
    }

    public IPodcastsCategory Podcasts
    {
        get => _categories.Podcasts;
        set => throw new NotSupportedException();
    }
    ...
    {
        return _invoke.Call(methodName, parameters, skipAuthorization);
    }
