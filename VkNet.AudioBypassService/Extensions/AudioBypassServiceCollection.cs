    ...
    public static IServiceCollection AddAudioBypass([NotNull] this IServiceCollection services)
    {
        ...
        services.AddHttpClient<IVkApiInvoke, VkApiInvoke>(client =>
        {
            ...
            client.DefaultRequestHeaders.TryAddWithoutValidation("User-Agent",
                "VKAndroidApp/8.99-23423 (Android 12; SDK 32; arm64-v8a; MusicX; ru; 2960x1440)");
        ...
        services.TryAddKeyedSingleton<IAuthorizationFlow, WithoutPasswordAuthorizationFlow>(AndroidGrantType
            .WithoutPassword);
