...
public class Longread : IIdentifiable
{
    ...
    [JsonProperty("owner_photo")] public string OwnerPhoto { get; set; }

    [JsonProperty("photo")] public Cover Photo { get; set; }

    [JsonProperty("published_date")] public int PublishedDate { get; set; }
    ...
    [JsonProperty("can_report")] public bool CanReport { get; set; }
