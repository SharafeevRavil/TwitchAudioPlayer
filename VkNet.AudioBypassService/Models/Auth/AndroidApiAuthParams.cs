...
public record AndroidApiAuthParams(
    string Login,
    string Sid,
    ActionRequestedDelegate ActionRequestedAsync,
    IEnumerable<LoginWay> SupportedWays,
    string Password = null,
    AndroidGrantType AndroidGrantType = null,
    string PasskeyData = null) : IApiAuthParams
{
