...
public class VkApiAuth : IVkApiAuthAsync
{
    ...
    public VkApiAuth(IServiceProvider serviceProvider, IVkTokenStore tokenStore,
        [CanBeNull] ITokenRefreshHandler tokenRefreshHandler = null)
    {
    ...
    {
        if (_lastAuthParams is null || !_lastAuthParams.IsValid) throw new InvalidOperationException();
