...
public class Group : IIdentifiable
{
    ...
    [JsonProperty("is_admin")] public int IsAdmin { get; set; }

    [JsonProperty("is_member")] public int IsMember { get; set; }

    [JsonProperty("is_advertiser")] public int IsAdvertiser { get; set; }

    [JsonProperty("photo_50")] public string Photo50 { get; set; }

    [JsonProperty("photo_100")] public string Photo100 { get; set; }

    [JsonProperty("photo_200")] public string Photo200 { get; set; }

    [JsonProperty("member_status")] public int MemberStatus { get; set; }
