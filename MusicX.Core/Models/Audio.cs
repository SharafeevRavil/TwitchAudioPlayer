...
public class Audio : IEquatable<Audio>, IIdentifiable
{
    ...
    [JsonProperty("is_explicit")] public bool IsExplicit { get; set; }

    [JsonProperty("is_focus_track")] public bool IsFocusTrack { get; set; }

    [JsonProperty("is_licensed")] public bool IsLicensed { get; set; }
    ...
    [JsonProperty("short_videos_allowed")] public bool ShortVideosAllowed { get; set; }

    [JsonProperty("stories_allowed")] public bool StoriesAllowed { get; set; }
    ...
    [JsonProperty("genre_id")] public long? GenreId { get; set; }

    public bool IsAvailable { get; set; } = true;

    [JsonProperty("main_color")] public string MainColor { get; set; }

    [JsonProperty("featured_artists")] public List<MainArtist> FeaturedArtists { get; set; }

    public Photo? Thumb { get; set; }

    [JsonIgnore] public RecommendedPlaylist RecccomendedPlaylist { get; set; }
