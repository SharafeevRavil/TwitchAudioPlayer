...
{
    Task<AuthValidateAccountResponse> ValidateAccountAsync(string login, bool forcePassword = false,
        bool passkeySupported = false, [CanBeNull] IEnumerable<LoginWay> loginWays = null);

    Task<AuthValidatePhoneResponse> ValidatePhoneAsync(string phone, string sid, bool allowCallReset = true,
        [CanBeNull] IEnumerable<LoginWay> loginWays = null);
