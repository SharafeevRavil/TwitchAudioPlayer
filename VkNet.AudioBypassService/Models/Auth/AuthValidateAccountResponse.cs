...
public record NextVerificationStep(
    LoginWay VerificationMethod,
    bool HasAnotherVerificationMethods,
    [CanBeNull] string ExternalId);
...
public record NeedValidationAuthResponse(
    LoginWay ValidationType,
    string ValidationSid,
    [CanBeNull] string PhoneMask,
    LoginWay ValidationResend,
    [CanBeNull] string ValidationExternalId);