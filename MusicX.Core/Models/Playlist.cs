...
public class Playlist : IIdentifiable
{
    ...
    [JsonProperty("plays")] public long Plays { get; set; }
    ...
    [JsonProperty("original")] public Original? Original { get; set; }

    [JsonProperty("followed")] public Followed? Followed { get; set; }

    [JsonProperty("photo")] public Photo? Photo { get; set; }

    [JsonProperty("permissions")] public Permissions Permissions { get; set; }

    [JsonProperty("subtitle_badge")] public bool SubtitleBadge { get; set; }

    [JsonProperty("subtitle")] public string Subtitle { get; set; }

    [JsonProperty("play_button")] public bool PlayButton { get; set; }

    [JsonProperty("access_key")] public string AccessKey { get; set; }

    [JsonProperty("is_explicit")] public bool IsExplicit { get; set; }

    [JsonProperty("main_artists")] public List<MainArtist> MainArtists { get; set; } = new();

    [JsonProperty("album_type")] public string AlbumType { get; set; }

    [JsonProperty("audios")] public List<Audio> Audios { get; set; } = new();
