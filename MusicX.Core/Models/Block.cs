...
public class Block : IIdentifiable
{
    ...
    [JsonProperty("layout")] public Layout Layout { get; set; }

    [JsonProperty("catalog_banner_ids")] public List<int> CatalogBannerIds { get; set; } = [];

    [JsonProperty("links_ids")] public List<string> LinksIds { get; set; } = [];

    [JsonProperty("buttons")] public List<Button> Buttons { get; set; } = [];

    [JsonProperty("actions")] public List<Button> Actions { get; set; } = [];

    [JsonProperty("next_from")] public string NextFrom { get; set; }

    [JsonProperty("url")] public string Url { get; set; }

    [JsonProperty("listen_events")] public List<string> ListenEvents { get; set; } = [];

    [JsonProperty("playlists_ids")] public List<string> PlaylistsIds { get; set; } = [];

    [JsonProperty("suggestions_ids")] public List<string> SuggestionsIds { get; set; } = [];

    [JsonProperty("artists_ids")] public List<string> ArtistsIds { get; set; } = [];

    [JsonProperty("badge")] public Badge Badge { get; set; }

    [JsonProperty("audios_ids")] public List<string> AudiosIds { get; set; } = [];

    [JsonProperty("curators_ids")] public List<long> CuratorsIds { get; set; } = [];

    [JsonProperty("group_ids")] public List<long> GroupIds { get; set; } = [];

    [JsonProperty("text_ids")] public List<string> TextIds { get; set; } = [];

    [JsonProperty("podcast_episodes_ids")] public List<string> PodcastEpisodesIds { get; set; } = [];

    [JsonProperty("podcast_slider_items_ids")]
    public List<string> PodcastSliderItemsIds { get; set; } = [];

    [JsonProperty("longreads_ids")] public List<string> LongreadsIds { get; set; } = [];

    [JsonProperty("videos_ids")] public List<string> VideosIds { get; set; } = [];

    [JsonProperty("artist_videos_ids")] public List<string> ArtistVideosIds { get; set; } = [];

    [JsonProperty("placeholder_ids")] public List<string> PlaceholdersIds { get; set; } = [];

    [JsonProperty("music_owners_ids")] public List<string> MusicOwnerIds { get; set; } = [];

    [JsonProperty("audio_followings_update_info_ids")]
    public List<string> FollowingUpdateInfoIds { get; set; } = [];

    [JsonProperty("group_items")] public List<CuratorGroup> GroupsItemsIds { get; set; } = [];
