...
public class Button
{
    ...
    [JsonProperty("ref_items_count")] public int RefItemsCount { get; set; }

    [JsonProperty("ref_layout_name")] public string RefLayoutName { get; set; }

    [JsonProperty("ref_data_type")] public string RefDataType { get; set; }

    [JsonProperty("block_id")] public string BlockId { get; set; }

    [JsonProperty("options")] public List<OptionButton> Options { get; set; } = new();
