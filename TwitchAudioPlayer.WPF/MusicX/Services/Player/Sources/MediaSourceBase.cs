...
public abstract class MediaSourceBase : ITrackMediaSource
{
    ...
    public abstract Task<bool> OpenWithMediaPlayerAsync(MediaPlayer player, PlaylistTrack track,
        ...
        CancellationToken cancellationToken = default)
    {
        ...
        foreach (var option in MediaOptions.DemuxerOptions.PrivateOptions) options.Add(option.Key, option.Value);
