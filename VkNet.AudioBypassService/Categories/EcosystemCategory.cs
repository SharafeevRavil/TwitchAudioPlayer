...
public class EcosystemCategory : IEcosystemCategory
{
    ...
    {
        return _invoke.CallAsync<EcosystemSendOtpResponse>("ecosystem.sendOtpSms", new VkParameters
        {
            { "sid", sid },
            { "api_id", 2274003 }
        });
    ...
    {
        return _invoke.CallAsync<EcosystemSendOtpResponse>("ecosystem.sendOtpPush", new VkParameters
        {
            { "sid", sid },
            { "api_id", 2274003 }
        });
    ...
    {
        return _invoke.CallAsync<EcosystemSendOtpResponse>("ecosystem.sendOtpCallReset", new VkParameters
        {
            { "sid", sid },
            { "api_id", 2274003 }
        });
    ...
    {
        return _invoke.CallAsync<EcosystemCheckOtpResponse>("ecosystem.checkOtp", new VkParameters
        {
            { "sid", sid },
            { "api_id", 2274003 },
    ...
    {
        return _invoke.CallAsync<EcosystemGetVerificationMethodsResponse>("ecosystem.getVerificationMethods",
            new VkParameters
            {
                { "sid", sid },
                { "api_id", 2274003 }
