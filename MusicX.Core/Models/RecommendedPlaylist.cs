...
public class RecommendedPlaylist : IIdentifiable
{
    ...
    [JsonProperty("percentage_title")] public string PercentageTitle { get; set; }

    [JsonProperty("audios")] public List<string> AudiosIds { get; set; }
    ...
    [JsonIgnore] public List<Audio> Audios { get; set; } = new();
